...
This file creates a word embedding model using all emails within the company, then creates a sentence embedding finding the centroid
...
Run Command: python EmailCorpus_Centroid.py
...
if __name__ == '__main__':
    ...
    np.savetxt('np_q1_similarity_score_centroid_Email.txt', np_q1_similarity_score)
    ...
    np.savetxt('np_q2_similarity_score_centroid_Email.txt', np_q2_similarity_score)
    ...
    np.savetxt('np_q3_similarity_score_centroid_Email.txt', np_q3_similarity_score)
