...
This file creates a word embedding model using all answers by applicants, then uses Word Mover Distance between applicants
to find their "linguistic similarity score"

Run Command: python AnswerCorpus_WMD.py
...
if __name__ == '__main__':
    ...
    np.savetxt('np_q1_keep_Q1_index.txt', np.array(keep_indexQ1))
    ...
    np.savetxt('np_q1_similarity_score_wmd.txt', np_q1_similarity_score)
    ...
    np.savetxt('np_q2_similarity_score_wmd.txt', np_q2_similarity_score)
    ...
    np.savetxt('np_q3_similarity_score_wmd.txt', np_q3_similarity_score)
